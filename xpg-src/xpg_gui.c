 ...
 */
void button_drag_leave(GtkWidget *btn, GdkDragContext *cnt, guint time, void *data)
{
	GdkEventCrossing ev;
 ...
 * text widget itself
 */
void text_drop_data(GtkWidget *w, GdkDragContext *context, gint x, gint y,
 ...
 */
void file_drop_data(GtkWidget *label, GdkDragContext *context, gint x, gint y,
										GtkSelectionData *data, guint info, guint time, page_t *pg)
{
	char *arg, *f;
	int len, num;
 ...
 *
 */
void mk_options_notebook(cfg_t *app, GtkWidget *menu, char *path)
{
	page_t *pg;
	int len;
	char *file;
 ...
 *
 */
void mk_about_notebook(cfg_t *app, GtkWidget *menu)
{
	page_t *pg;
	GtkWidget *label;
 ...
 */
void gui_main(char *path, wgeo_t *geo, int nb_tabpos, int active,
							char **files, int num)
{
